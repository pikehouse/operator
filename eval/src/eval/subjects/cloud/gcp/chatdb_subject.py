...
from eval.subjects.chat_db_app.profiles import CHAOS_PROFILES as _SHARED_CHAOS_PROFILES
...
class GCPChatDBAppSubject(CloudSubjectBase):
    ...
    # Per-defect chaos profiles — imported from shared module
    CHAOS_PROFILES = _SHARED_CHAOS_PROFILES
