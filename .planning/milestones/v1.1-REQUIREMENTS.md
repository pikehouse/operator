# Requirements Archive: v1.1 TUI Demo
...
**Notes:**
- Recovery chapter updated to clarify that demo (not agent) performs node restart
- Agent action execution explicitly deferred to v2
