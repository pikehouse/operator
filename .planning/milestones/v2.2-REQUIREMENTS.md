# Requirements Archive: v2.2 Agentic Remediations Demo
...
- [x] **TIKV-02**: Node kill chaos -> drain_store action -> verify store drained
...
**Shipped:** 11 of 11 v2.2 requirements
**Adjusted:** TIKV-02 changed from transfer-leader to drain_store (more appropriate for node-down scenario)
**Dropped:** None

---
*Archived: 2026-01-27 as part of v2.2 milestone completion*
